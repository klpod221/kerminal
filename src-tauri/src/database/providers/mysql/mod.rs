...
impl MySQLProvider {
    ...
    fn get_pool(&self) -> DatabaseResult<&Arc<RwLock<MySqlPool>>> {
        self.pool
            .as_ref()
...
impl Database for MySQLProvider {
    ...
    async fn create_tables(&self) -> DatabaseResult<()> {
        Err(DatabaseError::NotImplemented(
            "MySQL table creation not yet implemented".to_string(),
        ))
    }
    ...
    async fn execute_raw(&self, _query: &str, _params: &[&dyn ToSqlValue]) -> DatabaseResult<u64> {
        Err(DatabaseError::NotImplemented(
            "MySQL execute_raw not yet implemented".to_string(),
        ))
    }
    ...
    async fn fetch_raw(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL fetch_raw not yet implemented".to_string(),
        ))
    }
    ...
    async fn save_ssh_profile(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL save_ssh_profile not yet implemented".to_string(),
        ))
    }
    ...
    async fn find_ssh_profile_by_id(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL find_ssh_profile_by_id not yet implemented".to_string(),
        ))
    }

    async fn find_all_ssh_profiles(&self) -> DatabaseResult<Vec<crate::models::ssh::SSHProfile>> {
        Err(DatabaseError::NotImplemented(
            "MySQL find_all_ssh_profiles not yet implemented".to_string(),
        ))
    }
    ...
    async fn update_ssh_profile(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL update_ssh_profile not yet implemented".to_string(),
        ))
    }

    async fn delete_ssh_profile(&self, _id: &str) -> DatabaseResult<()> {
        Err(DatabaseError::NotImplemented(
            "MySQL delete_ssh_profile not yet implemented".to_string(),
        ))
    }

    async fn save_ssh_group(&self, _model: &crate::models::ssh::SSHGroup) -> DatabaseResult<()> {
        Err(DatabaseError::NotImplemented(
            "MySQL save_ssh_group not yet implemented".to_string(),
        ))
    }
    ...
    async fn find_ssh_tunnel_by_id(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL find_ssh_tunnel_by_id not yet implemented".to_string(),
        ))
    }

    async fn find_all_ssh_tunnels(&self) -> DatabaseResult<Vec<crate::models::ssh::SSHTunnel>> {
        Err(DatabaseError::NotImplemented(
            "MySQL find_all_ssh_tunnels not yet implemented".to_string(),
        ))
    }
    ...
    async fn find_ssh_tunnels_by_profile_id(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL find_ssh_tunnels_by_profile_id not yet implemented".to_string(),
        ))
    }
    ...
    async fn find_auto_start_ssh_tunnels(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL find_auto_start_ssh_tunnels not yet implemented".to_string(),
        ))
    }
    ...
    async fn update_ssh_tunnel(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL update_ssh_tunnel not yet implemented".to_string(),
        ))
    }

    async fn delete_ssh_tunnel(&self, _id: &str) -> DatabaseResult<()> {
        Err(DatabaseError::NotImplemented(
            "MySQL delete_ssh_tunnel not yet implemented".to_string(),
        ))
    }
    ...
    async fn save_saved_command(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL save_saved_command not yet implemented".to_string(),
        ))
    }
    ...
    async fn find_saved_command_by_id(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL find_saved_command_by_id not yet implemented".to_string(),
        ))
    }
    ...
    async fn find_all_saved_commands(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL find_all_saved_commands not yet implemented".to_string(),
        ))
    }
    ...
    async fn update_saved_command(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL update_saved_command not yet implemented".to_string(),
        ))
    }

    async fn delete_saved_command(&self, _id: &str) -> DatabaseResult<()> {
        Err(DatabaseError::NotImplemented(
            "MySQL delete_saved_command not yet implemented".to_string(),
        ))
    }

    async fn increment_command_usage(&self, _id: &str) -> DatabaseResult<()> {
        Err(DatabaseError::NotImplemented(
            "MySQL increment_command_usage not yet implemented".to_string(),
        ))
    }

    async fn toggle_command_favorite(&self, _id: &str) -> DatabaseResult<()> {
        Err(DatabaseError::NotImplemented(
            "MySQL toggle_command_favorite not yet implemented".to_string(),
        ))
    }
    ...
    async fn save_saved_command_group(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL save_saved_command_group not yet implemented".to_string(),
        ))
    }
    ...
    async fn find_saved_command_group_by_id(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL find_saved_command_group_by_id not yet implemented".to_string(),
        ))
    }
    ...
    async fn find_all_saved_command_groups(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL find_all_saved_command_groups not yet implemented".to_string(),
        ))
    }
    ...
    async fn update_saved_command_group(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL update_saved_command_group not yet implemented".to_string(),
        ))
    }

    async fn delete_saved_command_group(&self, _id: &str) -> DatabaseResult<()> {
        Err(DatabaseError::NotImplemented(
            "MySQL delete_saved_command_group not yet implemented".to_string(),
        ))
    }
    ...
    async fn save_master_password_entry(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL save_master_password_entry not yet implemented".to_string(),
        ))
    }
    ...
    async fn get_master_password_entry(
        ...
        Err(DatabaseError::NotImplemented(
            "MySQL get_master_password_entry not yet implemented".to_string(),
        ))
    }

    async fn update_master_password_last_verified(&self, _device_id: &str) -> DatabaseResult<()> {
        Err(DatabaseError::NotImplemented(
            "MySQL update_master_password_last_verified not yet implemented".to_string(),
        ))
    }

    async fn delete_master_password_entry(&self, _device_id: &str) -> DatabaseResult<()> {
        Err(DatabaseError::NotImplemented(
            "MySQL delete_master_password_entry not yet implemented".to_string(),
        ))
    }

    async fn save_device(&self, _device: &crate::models::auth::Device) -> DatabaseResult<()> {
        Err(DatabaseError::NotImplemented(
            "MySQL save_device not yet implemented".to_string(),
        ))
    }
